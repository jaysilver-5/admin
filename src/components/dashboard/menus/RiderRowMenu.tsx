...
export default function RiderRowMenu({
  open,
  anchor,
  status,
  onClose,
      ...
      case "verified":
        return (
          <>
            ...
            <Row onClick={onUpgrade}>Upgrade rider</Row>
            <Row danger onClick={onSuspend}>Suspend Rider</Row>
          </>
        );
      case "suspended":
        return (
          <>
            <Row onClick={onViewProfile}>View profile</Row>
            <Row onClick={onUpgrade}>Upgrade rider</Row>
            <Row danger onClick={onActivate}>Activate rider</Row>
          </>
        );
      case "pending":
        return (
          <>
            ...
            <Row onClick={onApprove}>Approve rider</Row>
            <Row danger onClick={onActivate}>Activate rider</Row>
          </>
        );
      case "rejected":
        return (
          <>
            <Row onClick={onViewProfile}>View profile</Row>
            <Row onClick={onUpgrade}>Upgrade rider</Row>
            <Row danger onClick={onApprove}>Approve rider</Row>
          </>
        );
    }
  })();
