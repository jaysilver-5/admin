          ...
          {merchants.map((m) => {
            ...
            return (
              <tr key={m.id} className={`hover:bg-gray-50 ${isSel ? "bg-blue-50/50" : ""}`}>
                ...
                <td className="px-4 py-4 text-sm font-medium text-gray-900 sm:px-6"><CopyableCell value={m.businessName} label="business name"/></td>
                <td className="px-4 py-4 text-sm text-gray-500 sm:px-6"><CopyableCell value={m.phoneNumber} label="phone number"/></td>
                <td className="px-4 py-4 text-sm text-gray-900 sm:px-6"><CopyableCell value={m.email} label="email address"/></td>
                <td className="px-4 py-4 text-sm text-gray-900 sm:px-6"><CopyableCell value={m.address} label="business address" lines={2}/></td>
                <td className="px-4 py-4 text-sm text-gray-500 sm:px-6"><CopyableCell value={m.lastLoginDate} label="last login date"/></td>
                <td className="px-4 py-4 text-sm text-gray-900 sm:px-6"><CopyableCell value={m.serviceTier} label="service tier"/></td>
